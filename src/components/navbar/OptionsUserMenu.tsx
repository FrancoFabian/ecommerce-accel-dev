...
const menuItems = [
  ...
  { id: "mi_paymetodes", text: "Datos de envio, pago y facturacion" },
...
export const OptionsUserMenu = memo(forwardRef<HTMLDivElement, OptionsUserMenuProps>(({isOpen},ref) => {
  return (
    <div
      ref={ref}
      style={{
      ...
      className={`
        hidden lg:flex sm:flex 
        transition-all duration-200 transform
        top-[70px] left-[25%] 2xl:left-[66%] lg:left-[68%] md:left-[65%] sm:left-[56%]
        ${
          isOpen
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              className="w-full relative flex flex-col gap-1 p-1"
