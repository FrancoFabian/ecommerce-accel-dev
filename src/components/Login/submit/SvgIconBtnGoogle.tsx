export interface SvgIconBtnProps {
    className?: string;
}
export const  SvgIconBtnGoogle = ({className}: SvgIconBtnProps) => {
    return (
      <svg
      className={className}
      ...
      >
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238A11.9 11.9 0 0124 36c-5.202 0-9.619-3.317-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44"
        />
        <path
          fill="#1976D2"
