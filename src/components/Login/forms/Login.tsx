...
export const Login = ({ isLogin, setIsLogin, forgotForm, setForgotForm }: LoginProps) => {
    ...
    return (
        <form
            ...
            flex-col gap-2 lg:gap-4 md:gap-4 sm:gap-4 2xl:gap-2 bg-white
            ...
            {state.message && (
                <div className={`width-full py-2 h-fit flex justify-center items-center 
                    ${state.success ? 'bg-green-100 border-green-500' : 'bg-red-100 border-red-500'}
